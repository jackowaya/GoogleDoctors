...
# Parser class for Lifescript. Gets: doctorId, First Name, Last Name, Gender, City, Zip code, State, Overall Avvo Rating (1-10), Experience (1-10), Industry recognition (1-10), Professional conduct (1-10), Average patient rating based on reviews (1-5), Number of Reviews, Overall rating (1-5), Helps patients understand their condition (1-5), Listens and addresses questions and concerns (1-5), Demonstrates bedside manner (1-5), Office staff is professional and courteous (1-5), Office facility is clean and comfortable (1-5)
...
sub new {
    my $class = shift;
    my $fieldsRef = ["ID", "First Name", "Last Name", "Gender", "City", "State", "Zip code", "Overall Avvo Rating (1-10)", "Experience (1-10)", "Industry recognition (1-10)", "Professional conduct (1-10)", "Average patient rating based on reviews (1-5)", "Number of Reviews", "Overall rating (1-5)", "Helps patients understand their condition (1-5)", "Listens and addresses questions and concerns (1-5)", "Demonstrates bedside manner (1-5)", "Office staff is professional and courteous (1-5)", "Office facility is clean and comfortable (1-5)"];
...
sub getDataFields {
    ...
    my $overallRating = "--";
    my $helpsPatientsUnderstand = "--";
    my $listensAddressesQuestions = "--";
    my $demonstratesBedsideManner = "--";
    my $officeStaffProfessional = "--";
    my $officeFacilityClean = "--";
    ...
    $output{"Overall rating (1-5)"} = $overallRating;
    $output{"Helps patients understand their condition (1-5)"} = $helpsPatientsUnderstand;
    $output{"Listens and addresses questions and concerns (1-5)"} = $listensAddressesQuestions;
    $output{"Demonstrates bedside manner (1-5)"} = $demonstratesBedsideManner;
    $output{"Office staff is professional and courteous (1-5)"} = $officeStaffProfessional;
    $output{"Office facility is clean and comfortable (1-5)"} = $officeFacilityClean;
    return %output;
}
